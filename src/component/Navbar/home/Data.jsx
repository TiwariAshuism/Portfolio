  ...
  return (
    <div className='home__data'>
        ...
        <svg
                ...
                <h3 className="home__subtitle">Viusal designer</h3>
                <p className="home__discription">With a passion for software space development and problem-solving</p><br></br>
